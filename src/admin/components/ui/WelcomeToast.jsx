...
const StatCard = ({
  ...
  }} className="ap-welcome-toast-1">
      <div className="ap-welcome-toast-2">{icon}</div>
      <div style={{
      color: isGreen ? "var(--success-border)" : "var(--text-faint)"
    }} className="ap-welcome-toast-3">{label}</div>
      <div className="ap-welcome-toast-4">
...
const WelcomeToast = ({
  ...
  }} className="ap-welcome-toast-5">
      <div style={{
      background: cardColor,
      transform: closing ? 'scale(.97) translateY(-6px)' : mounted ? 'scale(1) translateY(0)' : 'scale(.94) translateY(10px)',
      opacity: closing ? 0 : mounted ? 1 : 0
    }} className="ap-welcome-toast-6">
        <button onClick={handleClose} aria-label="Close" className="ap-welcome-toast-7">✕</button>

        <div className="ap-welcome-toast-8">
          <div style={{
          background: `radial-gradient(circle,
  ${isGreenPhase ? GREEN_LIGHT : '#334155'}30 0%,
  transparent 70%)`
        }} className="ap-welcome-toast-9" />
          <svg viewBox="0 0 100 100" className="ap-welcome-toast-10">
          ...
          }} className="ap-welcome-toast-11" />)}
          </svg>
          <div style={{
          background: isGreenPhase ? "var(--success)" : "var(--text-h2)",
          boxShadow: isGreenPhase ? "0 8px 28px var(--x15803d66), 0 0 0 6px var(--x15803d22)" : "0 8px 24px rgba(0,0,0,.4)"
        }} className="ap-welcome-toast-12">
        ...
        <div className="ap-welcome-toast-13">Welcome Back, {name}!</div>
        <div className="ap-welcome-toast-14">{panelLabel}</div>

        {stats.length > 0 && <div className="ap-welcome-toast-15">
      ...
      }} className="ap-welcome-toast-16">
          <div className="ap-welcome-toast-17">
            <span className="ap-welcome-toast-18">{greetingIcon}</span>
            <span className="ap-welcome-toast-19">{greetingLabel}</span>
          </div>
          <div style={{
          color: isGreenPhase ? "var(--success-border)" : "var(--text-faint)"
        }} className="ap-welcome-toast-20">
            {dateLabel}
          </div>
          <div style={{
          color: isGreenPhase ? "var(--success-bg)" : "var(--xcbd5e1)"
        }} className="ap-welcome-toast-21">
            Everything looks good.<br />
            Have a productive and successful day ahead! 🚀
          </div>
        </div>

        <div className="ap-welcome-toast-22">
          <span style={{
          color: isGreenPhase ? "var(--success-border)" : "var(--text-muted)"
        }} className="ap-welcome-toast-23">
            Loading your dashboard…
          </span>
          <span style={{
          color: isGreenPhase ? "var(--success-border)" : "var(--text-muted)"
        }} className="ap-welcome-toast-24">
            {secondsLeft}s
          </span>
        </div>
        <div className="ap-welcome-toast-25">
          <div style={{
          width: `${progress}%`,
          background: isGreenPhase ? "var(--success)" : "var(--text-body)"
        }} className="ap-welcome-toast-26" />
        </div>
      </div>
