...
const StatCard = ({
  ...
  }} className="tp-welcome-toast-1">
      <div className="tp-welcome-toast-2">{icon}</div>
      <div style={{
      color: isGreen ? "var(--success-border)" : "var(--faint)"
    }} className="tp-welcome-toast-3">{label}</div>
      <div className="tp-welcome-toast-4">
...
const WelcomeToast = ({
  ...
  }} className="tp-welcome-toast-5">
      <div style={{
      background: cardColor,
      transform: closing ? 'scale(.97) translateY(-6px)' : mounted ? 'scale(1) translateY(0)' : 'scale(.94) translateY(10px)',
      opacity: closing ? 0 : mounted ? 1 : 0
    }} className="tp-welcome-toast-6">
        <button onClick={handleClose} aria-label="Close" className="tp-welcome-toast-7">✕</button>

        <div className="tp-welcome-toast-8">
          <div style={{
          background: `radial-gradient(circle,
  ${isGreenPhase ? GREEN_LIGHT : '#334155'}30 0%,
  transparent 70%)`
        }} className="tp-welcome-toast-9" />
          <svg viewBox="0 0 100 100" className="tp-welcome-toast-10">
        ...
        <div className="tp-welcome-toast-13">Welcome Back, {name}!</div>
        <div className="tp-welcome-toast-14">{panelLabel}</div>

        {stats.length > 0 && <div className="tp-welcome-toast-15">
      ...
      }} className="tp-welcome-toast-16">
          <div className="tp-welcome-toast-17">
            <span className="tp-welcome-toast-18">{greetingIcon}</span>
            <span className="tp-welcome-toast-19">{greetingLabel}</span>
          </div>
          <div style={{
          color: isGreenPhase ? "var(--success-border)" : "var(--faint)"
        }} className="tp-welcome-toast-20">
            {dateLabel}
          </div>
          <div style={{
          color: isGreenPhase ? "var(--success-bg)" : "var(--disabled)"
        }} className="tp-welcome-toast-21">
            Everything looks good.<br />
            Have a productive and successful day ahead! 🚀
          </div>
        </div>

        <div className="tp-welcome-toast-22">
          <span style={{
          color: isGreenPhase ? "var(--success-border)" : "var(--muted)"
        }} className="tp-welcome-toast-23">
            Loading your dashboard…
          </span>
          <span style={{
          color: isGreenPhase ? "var(--success-border)" : "var(--muted)"
        }} className="tp-welcome-toast-24">
            {secondsLeft}s
          </span>
        </div>
        <div className="tp-welcome-toast-25">
          <div style={{
          width: `${progress}%`,
          background: isGreenPhase ? "var(--success)" : "var(--h2)"
        }} className="tp-welcome-toast-26" />
        </div>
      </div>
